...
@Configuration
@ComponentScan(basePackages = {"com.sorcererpaws.eSmartLabs"}, 
excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = {"com.sorcererpaws.eSmartLabs.web.*"}))
