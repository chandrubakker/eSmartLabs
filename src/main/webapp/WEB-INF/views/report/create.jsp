		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Create <small>Report of ${patient.name}</small>
						</h1>
					</div>
				</div>
				...
				<div class="row">
					...
					<validation:CRUD validateURL="/patient/report/update" requestMethod="POST" busyMessage="creating report of ${patient.name}..." asynch="false" callBackOnSuccess="reportCreationSuccess" formId="create-report" noSubmit="1" />
				</div>
			</div>
		</div>
