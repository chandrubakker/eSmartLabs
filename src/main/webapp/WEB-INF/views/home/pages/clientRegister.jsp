					...
					<div class="panel-body">
						...
						<form:form role="form" id="client-reg" action="" method="post"
							...
							<div class="form-group">
								<button type="button" onclick="registerServerSide();"
...
<script type="text/javascript">
	function registerServerSide() {
		...
		var formURL = "http://sorcererpaws.com/client/register?type=eSchool";
	...
	function registrationSuccessPage() {
		...
		$(".custom-name")
				.text(
						name
								+ ' Successfully Registered. Contact Super Admin to activate your account.')
