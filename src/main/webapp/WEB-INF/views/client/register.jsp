				...
				<div class="col-md-6 col-md-offset-3">
					...
					<div class="alert alert-success alert-white successAlert hide">
						...
						<p class="text-justify" style="font-size: 18px;">
							An confirmation link sent to email: <strong class="clientEmail"></strong> please check and confirm.
						</p>
						<p class="text-justify" style="font-size: 16px;">
							Note: In case you did not received the mail, please contact us via <a href="<c:url value="/contact-us" />">Contact</a> page
						</p>
					</div>
